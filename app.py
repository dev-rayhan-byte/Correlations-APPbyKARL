...
if uploaded_file:
    ...
    with tab1:
        ...
        for title, cmap, vmin, vmax in heatmap_configs:
            ...
            fig_px.update_traces(xgap=0, ygap=0)
            ...
            figsize_val = max(6, n_vars * 0.7)
            fig_dl, ax = plt.subplots(figsize=(figsize_val, figsize_val))
